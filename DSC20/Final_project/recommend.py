...
def find_closest(location, centroids):
    ...
    distances=[]
    for i in centroids:
        distances.append([i,distance(location,i)])
...
def group_by_centroid(restaurants, centroids):
    ...
    for i in restaurants:
        temp.append([find_closest(restaurant_location(i),centroids),i])
    return group_by_first(temp)
...
def find_centroid(cluster):
    ...
    long=[]
    for i in cluster:
        lat.append(restaurant_location(i)[0])
        long.append(restaurant_location(i)[1])
...
def find_predictor(user, restaurants, feature_fn):
    ...
    sxy=0
    for i in xs:
        sxx+=(i-mean(xs))**square
    for i in ys:
        syy+=(i-mean(ys))**square
...
def best_predictor(user, restaurants, feature_fns):
    ...
    for i in feature_fns:
        temp.append(find_predictor(user, reviewed,i))
